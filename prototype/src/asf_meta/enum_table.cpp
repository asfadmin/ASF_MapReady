...
enum_parse.pl last regenerated this file on Mon Jan 28 14:49:32 AKST 2008
*/
...
const asf::enum_value_description_t asf::metadata_2D_enum_table[]={
  ...
  { INTERFEROMETRIC_BASELINE,	"INTERFEROMETRIC_BASELINE",	"Interferometric baseline along this row: x=parallel, y=normal (meters of baseline)"},
...
const asf::enum_value_description_t asf::metadata_3D_enum_table[]={
  ...
  { IMAGE_PIXELS,	"IMAGE_PIXELS",	"XY meta image pixels (measured in meta pixels).  Z can be used as elevation."},
  { LONGITUDE_LATITUDE_DEGREES,	"LONGITUDE_LATITUDE_DEGREES",	"Longitude (x), geodetic latitude (y), and elevation (z) of target on planet surface (degrees,degrees,meters from ellipsoid)."},
  { LATITUDE_LONGITUDE_DEGREES,	"LATITUDE_LONGITUDE_DEGREES",	"Geodetic latitude (x), longitude (y), and elevation (z) of target on planet surface (degrees,degrees,meters from ellipsoid)."},
  { TARGET_POSITION,	"TARGET_POSITION",	"Location of dirt on planet surface in 3D body-fixed XYZ coordinates (meters)."},
  { SLANT_TIME_DOPPLER,	"SLANT_TIME_DOPPLER",	"Slant range (x), time (y), and doppler (z) at this image point (meters,seconds,Hz)."},
  { MAP_COORDINATES,	"MAP_COORDINATES",	"Return map projection coordinates in XY; elevation in Z (units vary; but normally all meters)."},
...
const asf::enum_value_description_t asf::metadata_int_enum_table[]={
  ...
  { LINE_COUNT,	"LINE_COUNT",	"Number of lines in image"},
  { SAMPLE_COUNT,	"SAMPLE_COUNT",	"Number of samples in image"},
