...
enum_parse.pl last regenerated this file on Thu Jul 13 14:23:19 AKDT 2006
*/
...
const asf::enum_value_description_t asf::projection_type_t_table[]={
  ...
  { STATE_PLANE_PROJECTION,	"STATE_PLANE_PROJECTION",	"Each US state legally defines its own separate projection"},
