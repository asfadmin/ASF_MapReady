...
enum_parse.pl last regenerated this file on Fri Jul 14 14:17:41 AKDT 2006
*/
...
const asf::enum_value_description_t asf::metadata_1D_enum_table[]={
  ...
  { TIME_SINCE_START,	"TIME_SINCE_START",	"Time of this point's aquisition relative to image start (seconds).  Computed from SLANT_TIME_DOPPLER in metadata_sar.cpp."},
  { TIME_SECONDS_OF_DAY,	"TIME_SECONDS_OF_DAY",	"Time of this point since midnight UTC (seconds).  This value will not jump around across midnight, which I claim is what you want!  Computed from IMAGE_START_SECONDS_OF_DAY and TIME_SINCE_START in metadata.cpp."},
...
const asf::enum_value_description_t asf::metadata_2D_enum_table[]={
  ...
  { LONGITUDE_LATITUDE_DEGREES,	"LONGITUDE_LATITUDE_DEGREES",	"Location of target on planet surface (decimal degrees)"},
...
const asf::enum_value_description_t asf::metadata_3D_enum_table[]={
  ...
  { TARGET_POSITION,	"TARGET_POSITION",	"Location of target in 3D body-fixed XYZ coordinates (meters).  Also XYZ_FROM_IMAGE"},
  { LONGITUDE_LATITUDE_ELEVATION_DEGREES,	"LONGITUDE_LATITUDE_ELEVATION_DEGREES",	"Location of target on planet surface (degrees,degrees,meters from ellipsoid).  Also LLE_FROM_IMAGE"},
  { SLANT_TIME_DOPPLER,	"SLANT_TIME_DOPPLER",	"Slant range (x), time (y), and doppler (z) at this image point (meters,seconds,Hz). Also STD_FROM_IMAGE"},
  { MAP_COORDINATES,	"MAP_COORDINATES",	"Return map projection coordinates in XY and elevation in Z (units vary; but normally all meters).  Also MAP_FROM_IMAGE"},
  { IMAGE_FROM_XYZ,	"IMAGE_FROM_XYZ",	"Input is TARGET_POSITION.  Output is image pixels."},
  { IMAGE_FROM_LLE,	"IMAGE_FROM_LLE",	"Input is LONGITUDE_LATITUDE_ELEVATION_DEGREES.  Output is image pixels."},
  { IMAGE_FROM_STD,	"IMAGE_FROM_STD",	"Input is SLANT_TIME_DOPPLER.  Output is image pixels."},
  { IMAGE_FROM_MAP,	"IMAGE_FROM_MAP",	"Input is MAP_COORDINATES.  Output is image pixels."},
  { LLE_FROM_MAP,	"LLE_FROM_MAP",	"Input is MAP_COORDINATES.  Output is LONGITUDE_LATITUDE_ELEVATION_DEGREES. (see meta_parameters.cpp)"},
  { MAP_FROM_LLE,	"MAP_FROM_LLE",	"Input is LONGITUDE_LATITUDE_ELEVATION_DEGREES.  Output is MAP_COORDINATES. (see meta_parameters.cpp)"},
  { LLE_FROM_XYZ,	"LLE_FROM_XYZ",	"Input is TARGET_POSITION.  Output is LONGITUDE_LATITUDE_ELEVATION_DEGREES. (see metadata.cpp)"},
  { XYZ_FROM_LLE,	"XYZ_FROM_LLE",	"Input is LONGITUDE_LATITUDE_ELEVATION_DEGREES.  Output is TARGET_POSITION. (see metadata.cpp)"},
  { STD_FROM_XYZ,	"STD_FROM_XYZ",	"Input is TARGET_POSITION.  Output is SLANT_TIME_DOPPLER. (see metadata_sar.cpp)"},
  { XYZ_FROM_STD,	"XYZ_FROM_STD",	"Input is SLANT_TIME_DOPPLER.  Output is TARGET_POSITION. (see metadata_sar.cpp)"},
...
const asf::enum_value_description_t asf::metadata_string_enum_table[]={
  ...
  { METADATA_SENSOR,	"METADATA_SENSOR",	"Short name of aquiring sensor, e.g. \"ERS1\"."},
  { METADATA_SENSOR_MODE,	"METADATA_SENSOR_MODE",	"Short name of sensor mode, e.g. \"FN1\"."},
  { METADATA_PROCESSOR,	"METADATA_PROCESSOR",	"Short name of image processing software, e.g., \"ASF/AISP/3.4\""},
...
const asf::enum_value_description_t asf::metadata_glob_enum_table[]={
  ...
  { META_PARAMETER_GLOB,	"META_PARAMETER_GLOB",	"Stored metadata, as a meta_parameters struct (see asf_meta/meta_parameters.h)"},
  { PROJECTION_PARAMETER_GLOB,	"PROJECTION_PARAMETER_GLOB",	"Map projection information, as a meta_projection struct"},
...
const asf::enum_value_description_t asf::metadata_int_enum_table[]={
  ...
  { DATUM_TYPE,	"DATUM_TYPE",	"The vertical datum in use: see datum_type_t below."},
