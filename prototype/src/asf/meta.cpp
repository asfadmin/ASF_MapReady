/*
Implementation of meta.h routines.
...
/* Utility routines (probably should be listed in main header) */
...
ASF_COREDLL bool asf::gregorian_leap_year(int year) {
...
*/
ASF_COREDLL double asf::julian_day_from_ymd(int year,int month,int day) {
...
ASF_COREDLL double asf::julian_day_from_yd(int year,int day) {
...
ASF_COREDLL double asf::julian_day_from_year(int targetYear)
{
#if 1
