...
void print_params(const char *in,struct AISP_PARAMS *a,const char *sourceProgram)
{
 ...
 fprintf(fp,"AISP2.5 SAR Processing Parameter File (%s)\n",sourceProgram);
...
MPI_Bcast(gbla->in1, 256, MPI_CHAR, 0, MPI_COMM_WORLD); 
MPI_Bcast(gbla->out, 256, MPI_CHAR, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->iflag, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->ifirstline, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->npatches, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->ifirst, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->na_valid, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->deskew, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->isave, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->nla, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->fd, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->fdd, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->fddd, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->re, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->vel, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->ht, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->r00, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->prf, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->azres, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->nlooks, 1, MPI_INT, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->fs, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->slope, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->pulsedur, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->nextend, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->wavl, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->rhww, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->pctbw, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->pctbwaz, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->sloper, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->interr, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->slopea, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->intera, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->dsloper, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->dinterr, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->dslopea, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->dintera, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
MPI_Bcast(&gbla->hamFlag, 1, MPI_INT, 0, MPI_COMM_WORLD);
MPI_Bcast(&gbla->kaiFlag, 1, MPI_INT, 0, MPI_COMM_WORLD); 
