...
void xpose(float *indata, int iRsiz, float *outdata, int oRsiz, int Nrows, int Ncols);
...
void cxpose(float *indata, int iRsiz, float *outdata, int oRsiz, int Nrows, int Ncols);
...
void cvprod(float *a, float *b, float *out, int N);
