...
/* Jason mod
 * Attention: the structure head should only be 6 Bytes long,
 * but C extends it to 8 Bytes, so in the file header after the 
 * Length of data block 2 more dummy Bytes are stored
 */
