...
static char sccsid_qfunc_decl_h[] = "@(#)qfunc_decl.h	1.20 96/12/30 15:45:39";
...
int    compute_offset_amount();

void   interpret_data_set_summary_record() ;
void   interpret_processed_data_histogram_record () ;
void   interpret_signal_data_histogram_record () ;
void   interpret_map_projection_data_record () ;
void   interpret_data_summary_quality_record () ;
void   get_projection_from_fdr();

int    compute_record_offset () ;

void   create_histogram_array_from_clipped_picture() ;
void   create_histogram_from_complex_picture() ;
...
void   draw_processed_histogram() ;
void   draw_processed_histogram_delimiting_lines () ;
void   draw_i_histogram() ;
void   draw_i_histogram_delimiting_lines () ;
void   draw_q_histogram() ;
void   draw_q_histogram_delimiting_lines () ;
...
void   reverse_picture();
void   get_visible_width_and_height();
