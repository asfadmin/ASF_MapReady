...
static char sccsid_qglobal_var_h[] = "@(#)qglobal_var.h	1.25 97/05/19 17:50:51";
...
EXTERN_IF_NOT_IN_MAIN   int      _boxed_image_width, _boxed_image_height;
...
EXTERN_IF_NOT_IN_MAIN    int          _processed_histogram_array[256],
                                      _processed_histogram_size,
...
EXTERN_IF_NOT_IN_MAIN    GC           _data_histogram_gc,
                                      _i_histogram_gc, _q_histogram_gc;
