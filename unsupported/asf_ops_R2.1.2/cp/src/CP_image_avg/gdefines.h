...
static char sccsid_qdefines_h[] =
	"@(#)gdefines.h	1.6 97/05/15 14:13:36";
...
#define  QC_LEADER_FILE_READ_ERROR         10

#define  QC_PROGRAMMER_ERROR               11

#define  QC_OPEN_CEOS_FILE_ERROR           12
#define  QC_CEOS_FILE_READ_ERROR           13
...
#define  QC_AVERAGE_FILE_READ_ERROR        18

#define  QC_IMPROPER_CEOS_VALUE            19
#define  QC_UNKNOWN_IMAGE_TYPE             20

#define  QC_IMAGE_PROBLEM                  21

#define  QC_OPEN_AVG_OUT_FILE_ERROR        22

#define  QC_NO_COLORS_AVAILABLE            23

#define  QC_LEADER_FILE_UNEXPECTED_READ_RETURN_ERROR		24
#define  QC_LOG_INIT_FAILED		25
...
/* for unsigned integer files: */
#define LEFT_PIXEL_PAD                  12
#define LEFT_PIXEL_PAD_NEW              192
...
#define NUMBER_OF_MAP_PROJECTION_DATA_RECORDS_LENGTH       6
#define NUMBER_OF_MAP_PROJECTION_DATA_RECORDS_OFFSET       192
