...
# @(#)Makefile.in	1.5 96/08/06 12:30:07
...
$(FLEX): .bootstrap $(OBJECTS) $(FLEXLIB)
	...
	@rm -f $(includedir)/yylex.h
	$(INSTALL_DATA) $(srcdir)/yylex.h $(includedir)/yylex.h
...
# After doing the initial "make all," do *not* bootstrap the new flex
# with the scan.c that can be created from scan.l.  Use the flex that
# was built with initscan.c.
#scan.c: scan.l
...
scan.o: parse.h flexdef.h config.h
yylex.o: parse.h flexdef.h config.h

skel.c: flex.skl mkskel.sh
	-@/bin/rm -f $@
	$(SHELL) $(srcdir)/mkskel.sh $(srcdir)/flex.skl >skel.c

# Why do dependencies of the .o on the .c files need to be explicitly
# stated here?
...
#skel.o: skel.c flexdef.h config.h yylex.h
#sym.o: sym.c flexdef.h config.h
#tblcmp.o: tblcmp.c flexdef.h config.h
main.o: flexdef.h config.h version.h
ccl.o: flexdef.h config.h
dfa.o: flexdef.h config.h
ecs.o: flexdef.h config.h
gen.o: flexdef.h config.h
misc.o: flexdef.h config.h
nfa.o: flexdef.h config.h
parse.o: flexdef.h config.h
skel.o: flexdef.h config.h yylex.h
sym.o: flexdef.h config.h
tblcmp.o: flexdef.h config.h
...
clean: mostlyclean
	-rm -f flex parse.c parse.h $(OBJECTS) $(LIBOBJS) alloca.c \
	    flex.lint flex.gcc-lint \
	    lex.yy.c lex.yy.cc \
	    $(FLEXLIB) config.log config.cache skel.c

distclean: clean
	-rm -f .bootstrap $(FLEX) scan.c tags TAGS Makefile config.status \
		config.h y.tab.c y.tab.h
