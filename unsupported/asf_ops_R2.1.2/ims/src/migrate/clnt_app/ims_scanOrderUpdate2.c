static char *sccs = "@(#)ims_scanOrderUpdate2.c	1.1  07/17/97";
/******************************************************************************
**
** File:        ims_scanOrderUpdate2.c
**
** Function:
**
** Author:      Sean Hardman
	...
	ORDER_SPEC *orderSpec)
{
	...
	*/
	(void) sprintf (cmdBuf,
		...
		"and g.PLATFORM = dl.PLATFORM "
		"and g.REVOLUTION = dl.REVOLUTION "
		"and g.SEQUENCE = dl.SEQUENCE "
