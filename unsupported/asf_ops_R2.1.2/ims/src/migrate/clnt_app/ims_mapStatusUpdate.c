char *sccs = "@(#)ims_mapStatusUpdate.c	1.2 07/17/97";
/******************************************************************************
**
** File:        ims_mapStatusUpdate
**
	...
	char *argv[])
{
	...
	*/
	...
	(void) ims_msg (msgDesc, IMS_INFO,
		"Ending the ims_mapStatusUpdate at index '%d' "
		"in granules table '%s' for dataset '%s'.",
	...
	*/
	(void) ims_msg (msgDesc, IMS_INFO,
		"ims_mapStatusUpdate processing completed successfully.");
