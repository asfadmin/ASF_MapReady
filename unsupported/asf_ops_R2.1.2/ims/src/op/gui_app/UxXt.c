 ...
 * CREATION:	Visual Edge Software		Apr 91
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
 ...
 * EXT REFS:	UxTopLevel, xcontext_id
 * CREATION:	Visual Edge Software		Apr 91
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
 ...
 * CREATION:	Visual Edge Software		Apr 93
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
 ...
 * CREATION:	Visual Edge Software		Jun 92
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
 ...
 * CREATION:	Visual Edge Software		Mar 93
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
...
/*------------------------------------------------------------------------------
 * NAME:	UxRemoveValueFromArgList
 * INPUT:	Arg		*args		- array of Arg's
 *		String		res_name	- name of resource
 * INPUT:	Cardinal	*ptr_num_args	- number of Arg's
 * OUTPUT:	Cardinal	*ptr_num_args	- number of Arg's
 ...
 * CREATION:	Visual Edge Software		Nov 92
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
 ...
 * RETURN:	Pointer to a data area of (at least) the desired size.
 * DESCRIPTION:	Allocate a context structure.
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
 ...
 * DESCRIPTION:	Make a component wrapping around the supplied Widget.
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
 ...
 * RETURN:	void* user reference data
 * DESCRIPTION:	Bind a component reference object to the Widget.
 * EXT REFS:	UxTopLevel, xadapter_id
 *----------------------------------------------------------------------------*/
#ifdef _NO_PROTO
