/*==============================================================================
Filename:	ims_archive_FAIF_PMF.c

Description:	
	Library function for ims_archive of a FAIF PMF, *without* an associated
        .D file
...
int ims_archive_FAIF_PMF (char *programName, char *configfile,
