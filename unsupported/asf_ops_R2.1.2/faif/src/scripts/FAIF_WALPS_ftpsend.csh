#!/bin/csh -f
#===============================================================================
# Filename:	FAIF_WALPS_ftpsend.csh
# Description:
...
# Notes:	
#	Wallops version of FAIF_UNIX_ftpsend.csh - does not perform the
#	get operation after doing a put since Wallops does not allow
#	enough time for it; Wallops ingests the file sent every 1 minute.
#	
# SCCS Info:
#  %M%
#  %R%
...
###############################################################
if ($#argv < 3) then
   echo "Usage: FAIF_WALPS_ftpsend.csh RemoteHost RemoteDir FileToSend Mode FAIFRootpath Username Password"
   exit 1
endif
...
###############################################################
set copydir = $tempdir/sentcopy.$unique
...
###############################################################
# Return zero without pulling file back for checking
###############################################################
exit 0
