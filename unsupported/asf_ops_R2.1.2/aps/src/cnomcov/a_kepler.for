...
C-- ==========================================================================
C--
C--  Fortran Filename:	a_kepler.for
C--
C--  Description:	
C--	
C--  Notes:
C--
C-- ==========================================================================
      SUBROUTINE A_KEPLER(AM,E,EA,SE,CE)  

      character*100 SccsFileID
     -/'@(#)a_kepler.for	5.1 98/01/08 APS/ASF\0'/
...
C    Changed subroutine name so it doesn't conflict with the vector library
C  COMMENTS  
...
C
   ...
   30 SE=DSIN(EA)   
      ...
      K=K+1 
      IF (K.GT.10) THEN
          print *,'a_kepler.for:  error encountered in the routine'
          print *,'               a_kepler.for.  This routine was '
          print *,'               copied from the ASAP program and '
          print *,'               used in the coverage program.  See'
          print *,'               this routine.'
