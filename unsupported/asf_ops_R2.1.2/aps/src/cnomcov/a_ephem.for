...
C-- ==========================================================================
C--
C--  Fortran Filename:	a_ephem.for
C--
C--  Description:	
C--	
C--  Notes:
...
C-- ==========================================================================
      ...
      SUBROUTINE A_EPHEM(ISUN,IMOON,ISRP,T,ES,EM)

      character*100 SccsFileID
     -/'@(#)a_ephem.for	5.1 98/01/08 APS/ASF\0'/
...
C    JOHNNY H. KWOK - JPL
C  MODIFICATIONS
C    Changed subroutine name so it doesn't conflict with vector library
C  COMMENTS
