...
/*==============================================================================
Filename:       mu_insert_single_perm.c
...
==============================================================================*/
#pragma ident   "@(#)mu_insert_single_perm.c	5.1 98/01/08 APS/ASF"
#pragma ident   "@(#) /home/aps/r2.1.2/src/lib_multiUser/SCCS/s.mu_insert_single_perm.c"


/*==============================================================================
Function:       mu_insert_single_perm()

Description:    inserts a single activity permission into the db.  
    ...
    int         permission_id )  /*  input:  the permission id to use.        */
{
    ...
    */
    perm_rec =  new_table_record(APS_CDEFS(ACTIVE_SINGLE_ACTIVITIES)) ;

    /*
    -- NODE               
    */
    (void) strcpy( CAST_ACTIVE_SINGLE_ACTIVITIES_NODE 
    ...
    -- PROCESS_ID         
    */
    (void) strcpy( CAST_ACTIVE_SINGLE_ACTIVITIES_PROCESS_ID
    ...
    -- KPID               
    */
    CAST_ACTIVE_SINGLE_ACTIVITIES_KPID perm_rec[ACTIVE_SINGLE_ACTIVITIES_KPID]
        = kpid ;

    /*
    -- COMMAND_NAME       
    */
    (void) strcpy( CAST_ACTIVE_SINGLE_ACTIVITIES_COMMAND_NAME
    ...
    -- PERMISSION_ID      
    */
    CAST_ACTIVE_SINGLE_ACTIVITIES_PERMISSION_ID 
        perm_rec[ACTIVE_SINGLE_ACTIVITIES_PERMISSION_ID]
        = permission_id ;

    /*
    -- MU_ACTIVITY_ID     
    */
    (void) strcpy( CAST_ACTIVE_SINGLE_ACTIVITIES_MU_ACTIVITY_ID
        perm_rec[ACTIVE_SINGLE_ACTIVITIES_MU_ACTIVITY_ID],
        mu_activity_id ) ;

    /*
    -- USERID             
    */
    (void) strcpy( CAST_ACTIVE_SINGLE_ACTIVITIES_USERID
        perm_rec[ACTIVE_SINGLE_ACTIVITIES_USERID],
        mu_unix_userid ) ;
    ...
    */
    ...
    (void) printf("\n%s(%d):  single activity to insert:\n", 
        __FILE__, __LINE__ ) ;
    db_print_record(perm_rec, APS_CDEFS(ACTIVE_SINGLE_ACTIVITIES) ) ;
    (void) printf("\n");
    ...
    if( nrecs_inserted != 1 )
        return MU_DB_ERROR_INSERTING_SINGLE_ACTIVITY ;
