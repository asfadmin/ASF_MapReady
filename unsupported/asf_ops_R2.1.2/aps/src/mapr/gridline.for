...
C-- ==========================================================================
C--
C--  Fortran Filename:	gridline.for
C--
C--  Description:	
C--	
C--  Notes:
...
C 8/5/94 Nadia Adhami	include mapper_port.inc
C
C-----------------------------------------------------------------
      SUBROUTINE GRIDLINE(PROJN,OBSLAT,OBSLON,
     1                    LAT1,LON1,LAT2,LON2)

      character*100 SccsFileID
     -/'@(#)gridline.for	5.1 98/01/08 APS/ASF\0'/
...
C WRITTEN BY CRAIG K. FUJIMOTO
C-----------------------------------------------------------------
      SUBROUTINE GRIDARC(PROJN,OBSLAT,OBSLON,
     1                   LAT,LON1,LON2)
