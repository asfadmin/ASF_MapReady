...
==============================================================================*/
#pragma ident	"@(#)mapr_getdup.c	5.1 98/01/08 APS/ASF"
#pragma ident	"@(#) /home/aps/r2.1.2/src/mapr/SCCS/s.mapr_getdup.c"
...
* 
*  Usage example:  	
*		extern int mapr_getdup( int argc, char **argv, char	
*			*extra_flags, char *dbname, char *sybase_userid, char *password );
*		.
*		.
*		.
*		err_code = mapr_getdup(argc, argv, "srt:", dbname, sybase_userid, password);
*		if(err_code == 1)
*			usage_exit(1);
*		if(err_code == 2)
