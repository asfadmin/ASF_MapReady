...
*  $Logfile:   ACS003:[BLD.MPS.LIB.SRC]SSCOVQ.FOV  $
...
*  THESE FOUR QUADRILATERAL POINTS ARE INPUT IN CLOCKWISE ORDER.  
*  Q1(3)	REAL*8	POINT 1 OF THE QUADRILATERAL
*  Q2(3)	REAL*8	POINT 2 OF THE QUADRILATERAL
*  Q3(3)	REAL*8	POINT 3 OF THE QUADRILATERAL
*  Q4(3)	REAL*8	POINT 4 OF THE QUADRILATERAL
...
*  Output Parameters:
*  Name         Type    Definition
*  START(10)	REAL*8	INFORMATION AT START OF SWATH COVERAGE OF QUADRILATERAL
...
*			SAME STRUCTURE AS IN POINTS.  
*			IF NO START COVERAGE FOR SITE, ALL VALUES ARE 0.0D00 
...
*                                                                   
*********************************************************************/
      SUBROUTINE SSCOVQ (Q1,Q2,Q3,Q4,POINT,NPOINT,START,STOP,ASCDSC)
      character*100 SccsFileID
     -/'@(#)sscovq.for	5.1 98/01/08 APS/ASF\0'/

      IMPLICIT NONE
      REAL*8 POINT(10,*),Q1(3),Q2(3),Q3(3),Q4(3), START(10), STOP(10)
      CHARACTER*(*) ASCDSC
...
CCCC      WRITE(*,*) 'SSCOVQ:  BEGINNING OF SWATH COV'
      DO 2000 J = 1,NPOINT-1
C---	SWATH ENTERS THE QUADRILATERAL:
      K = J + 1
      CALL SWENTQ(Q1,Q2,Q3,Q4,
C---                  SW LEFT 1  SW RT 1    SW LEFT 2  SW RT 2
     ?                POINT(5,J),POINT(8,J),POINT(5,K),POINT(8,K),FRAC)
...
C---	NO COVERAGE BECAUSE NO ENTRY DETECTED.  
      GO TO 9999
 3000 CONTINUE
CCCC      WRITE(*,*) 'SSCOVQ:  END OF SWATH COV'
...
C---	AND THE FACT THAT THE RESULTS GO INTO THE START ARRAY.  
      ...
      K = J - 1
      CALL SWENTQ(Q1,Q2,Q3,Q4,
     ?               POINT(8,J),POINT(5,J),POINT(8,K),POINT(5,K),FRAC)
