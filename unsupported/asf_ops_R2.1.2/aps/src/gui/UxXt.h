...
#if defined(MOTIF_PRIOR_1_2_3) || !(defined(__cplusplus) || defined(c_plusplus))
extern	void		UxMrmRegisterClass( char *, Widget (*)());
#else
extern	void    	UxMrmRegisterClass( char *, Widget (*)(...));
#endif /* MOTIF_PRIOR_1_2_3 */
#endif /* _NO_PROTO */
#endif /* UIL_CODE */
...
extern	Widget		UxInheritedChildSite();
...
extern	Widget		UxInheritedChildSite( Widget );
 ...
 * DESCRIPTION:	Creates a component swidget for any Widget.
