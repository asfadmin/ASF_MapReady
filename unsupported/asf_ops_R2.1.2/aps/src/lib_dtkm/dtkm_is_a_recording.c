...
/*==============================================================================
Filename:   dtkm_is_a_recording.c
...
==============================================================================*/
#pragma ident   "@(#)dtkm_is_a_recording.c	5.1 98/01/08 APS/ASF"
#pragma ident   "@(#) /home/aps/r2.1.2/src/lib_dtkm/SCCS/s.dtkm_is_a_recording.c"



/*==============================================================================
Function:       dtkm_is_a_recording()

Description:    returns TRUE if data-take is a recording.  
...
int dtkm_is_a_recording( DB_RECORD **dtk_rec )
{
    ...
    /* check of RECording observation:  */
