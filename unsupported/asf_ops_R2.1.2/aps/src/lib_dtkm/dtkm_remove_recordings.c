THIS SOURCE FILE IS OBSOLETE AND REPLACED BY dtkm_remove_observations.c
Sun Mar  9 15:23:01 PST 1997
...
/*==============================================================================
Filename:   dtkm_remove_recordings.c
...
==============================================================================*/
#pragma ident   "@(#)dtkm_remove_recordings.c	5.1 98/01/08 APS/ASF"
#pragma ident   "@(#) /home/aps/r2.1.2/src/lib_dtkm/SCCS/s.dtkm_remove_recordings.c"

#include "dtkm.h"


/*==============================================================================
Function:       dtkm_remove_recordings

Description:    remove recording data-takes from a list, retaining
...
==============================================================================*/
int dtkm_remove_recordings( llist *dtk_list )
{
    ...
    while ( dtk_rec )
    {
        ...
        {
            /* 
            -- this is a non-downlink data-take; destroy 
