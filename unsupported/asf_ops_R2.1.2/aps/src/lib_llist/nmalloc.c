...
Description:	Replacement for malloc() and free().  It keeps track of memory
		allocated and free'ed to allow tracking of memory leaks.
Externals:
...
=============================================================================*/
#pragma ident	"@(#)nmalloc.c	5.1 98/01/08 APS/ASF"
#pragma ident	"@(#) /home/aps/r2.1.2/src/lib_llist/SCCS/s.nmalloc.c"
