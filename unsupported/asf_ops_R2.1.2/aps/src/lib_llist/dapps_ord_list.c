...
=============================================================================*/
#pragma ident	"@(#)dapps_ord_list.c	5.1 98/01/08 APS/ASF"
#pragma ident	"@(#) /home/aps/r2.1.2/src/lib_llist/SCCS/s.dapps_ord_list.c"
...
=============================================================================*/
static void		*Insert_Entry_by_Key();
...

{
	...
	if ( ( list_p == (ord_llist *)NULL ) || ( list_p->initialized != TRUE ) )
	{
		llist_errno = EBADLIST;
		return( NULL );
	}
