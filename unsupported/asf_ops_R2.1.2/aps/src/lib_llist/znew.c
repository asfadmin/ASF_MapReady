...
==============================================================================*/
#pragma ident	"@(#)znew.c	5.1 98/01/08 APS/ASF"
#pragma ident	"@(#) /home/aps/r2.1.2/src/lib_llist/SCCS/s.znew.c"
...
int	retval;
	...
	/*
	-- NOTE:  the following 2 statments were reversed.  
	-- it is correct to first zero out the bytes, then 
	-- free the memory.  not the other way around.  
	*/
    bzero( cptr , nbytes );
    FREE( cptr );
}
