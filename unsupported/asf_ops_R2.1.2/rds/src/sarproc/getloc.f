	subroutine getloc(leftlook,statevec,range,fd,aguess,targacc,
     .deltafd,targlat,targphi,targrad,*)
c/*   subroutine getloc(statevec,range,fd,aguess,targacc,deltafd,targlat, -----
c    .targphi,targrad,*)
c
c   subroutine getloc   R.E. Carande   July 1988
c			T.N. Truong    June 1996	Left looking SAR
c
...
c                                                                     
c
c   Input:      leftlook:  TRUE = left looking SAR, FALSE = right looking
c		statevec:  double precision 6 element x,y,z,xdot,ydot,zdot
c			   of s/c
...
c   xsc + rvec = rt             
	...
	data pi/3.141592654/,itmax/1000/   
      character*80 sccsid
      data sccsid /'@(#)getloc.f	1.4 96/07/11 16:59:51\0'/
c                         
...
c	side='r'       ! looking toward right of flight path      
