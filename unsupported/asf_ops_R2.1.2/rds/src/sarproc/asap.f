      SUBROUTINE ASAP(ORB, TINT, TFIN, TREF, PROP_VEC)
c     SUBROUTINE ASAP
C
C/*	SUBROUTINE ASAP  --------------------------
C
...
C*/
     ...
     1  ,IPRINT,INODE,IPLOT
      ...
      character*80 sccsid
      data sccsid /'@(#)asap.f	1.5 96/04/24 17:53:11\0'/

      DATA L, M /20, 20/
      DATA IRES, ISUN, IMOON /0, 0, 0/
      DATA IEPHEM, IDRAG, IDENS /1, 0, 1/
      DATA ISRP, IORB /0, 0/
      DATA IPRINT, INODE, IPLOT /0, 0, 0/
      DATA RELERR, ABSERR /1.0D-12, 1.0D-12/
      DATA STEP /60.D0/
      DATA GE, RE /3.9860045D5, 6378.140D0/
      DATA RATE /0.4178074216D-02/
      DATA PM /99.652865509D0/
      ...
      DATA CDRAG /2.0D0/
      DATA CSRP /6.6D-03/
      DATA GS /0.13271244D12/
      DATA ES /0.D0, 0.D0, 0.D0, 0.D0, 0.D0, 0.D0, 0.D0/
      DATA GM /0.490279D4/
      DATA EM /0.D0, 0.D0, 0.D0, 0.D0, 0.D0, 0.D0, 0.D0/
...
C
c     OPEN(5,FILE='5')
c     READ(5,4000)L,M,IRES,ISUN,IMOON,IEPHEM,IDRAG,IDENS,ISRP,IORB
c    1  ,IPRINT,INODE,IPLOT
c     READ(5,3000)(ORB(I),I=1,6),RELERR,ABSERR,STEP
c     READ(5,3000)(TINT(I),I=1,2),(TFIN(I),I=1,2),(TREF(I),I=1,2)
c     READ(5,3000)GE,RE,RATE,PM,ELLIP,RATM
c     READ(5,3000)RDENS,RHT,SHT,ALTMAX,WT
c     READ(5,3000)AREAD,AREAS,SCMASS,CDRAG,CSRP
c     READ(5,3000)GS,(ES(I),I=1,7)
c     READ(5,3000)GM,(EM(I),I=1,7)
C
...
C
   ...
   10 S(I,J)=ZERO
c     DO 20 N=1,2000
c     READ(5,5000,END=30)I,J,C(I+1,J+1),S(I+1,J+1)
c  20 CONTINUE

      C(3, 1) = -0.10826271D-02
      S(3, 1) = 0.D0
