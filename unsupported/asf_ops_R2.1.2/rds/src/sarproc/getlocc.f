	subroutine getlocc(leftlook,statevec,range,fd,re,rp,xlambda,
     .iyear,iday,ihour,min,sec,
     .targlat,targlon,targrad,istat)
c/*	subroutine getlocc(statevec,range,fd,re,rp,xlambda, --------------------
...
c		 targlon:  geocentric longitude+hourangle of target (double)
...
c*/
	...
	data pi/3.141592654/
      character*80 sccsid
      data sccsid /'@(#)getlocc.f	1.4 96/07/11 16:58:44\0'/
c                         
...
c   call getloc
c
	call getloc (leftlook,statevec,range,fd,aguess,targacc,deltafd,
     .targlat,targphi,targrad,*1000)
c
