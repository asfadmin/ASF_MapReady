...
C*****WAYNE******
       include 'ssp2_const.inc'
        ...
        data SccsId /'@(#)PPget_config.f:2.41'/
...
C*******************************************************
        file_w1_rg= '/home/tmpdisk/ANT/w1_si.dat'
        file_w2_rg= '/home/tmpdisk/ANT/w2_si.dat'
        file_w3_rg= '/home/tmpdisk/ANT/w3_si.dat'
        file_s5_rg= '/home/tmpdisk/ANT/s5_si.dat'
        file_s6_rg= '/home/tmpdisk/ANT/s6_si.dat'
...
c Coefficient result from setp 24
        az_peak_coef(1,1) = 0.780951861517609980 
        az_peak_coef(2,1) = -0.426185187054352321E-01
        az_peak_coef(3,1) = 0.705454457010375939E-03

c Shift one PRF forward 
        az_peak_coef(1,2) = 0.974348007221512713
        az_peak_coef(2,2) = -0.560028842550175446E-01
        az_peak_coef(3,2) = 0.938692946014375428E-03

c Shift one PRF backward
        az_peak_coef(1,5) = 1.34725855936480921
        az_peak_coef(2,5) = -0.762907101539281457E-01
        az_peak_coef(3,5) = 0.121076357536275148E-02

        az_peak_coef(1,6) = -0.216025246239349961
        az_peak_coef(2,6) = 0.862524456859467548E-02
        az_peak_coef(3,6) = 0.560120672591322017E-04
