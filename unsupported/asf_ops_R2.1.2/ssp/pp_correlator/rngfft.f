c SccsId = @(#)rngfft.f	2.41 3/24/98


	subroutine rngfft(iflag,
	...
	do i = n_cntr-nband/2, n_cntr+nband/2-1
c	if(i/256*256.eq.i) print *, 'range = ', i
	call cfft(buff_in(1,i),increa,rng_in,iflag)
	end do
