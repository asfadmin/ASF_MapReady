c SccsId = @(#)rngfft_intp.f	2.41 3/24/98


	subroutine rngfft_intp(iflag,
     ...
     +  raw_file,image_file)
        ...
        character*128 SccsId_rngfft_intp
        data SccsId_rngfft_intp
     +  /'@(#)PPrngfft_intp.f:2.41'/
	...
	do i = 1, az_in
	call cfft(buff_in_rd(1,i),increa,rng_in,iflag)
	end do
