...
c     print*,'Welcome to the fit routine with order of ',iorder
      incvm = ncvm
      ma = iorder+1
      mfit = ma
      do i=1,ma
      ...
      performance = chisq
c     do i=1,ma
c        print*,' the variance of output coeff',i,'(value=',
c    1            a(i),') is',covar(i,i)
c     end do
c     print*,' CHI-SQUARED is =',chisq
