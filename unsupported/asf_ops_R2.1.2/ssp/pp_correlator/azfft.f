c SccsId = @(#)azfft.f	2.41 3/24/98
	
	
	subroutine azfft(iflag,
	...
	call init_fft(az_in)
	n1 = 0
	if(iflag.lt.0) n1 = fs*plen

	do i = 1, rng_in-n1
c	if(i/256*256.eq.i) print *, 'azmuth = ', i
	call get_az_line(i,
     +  rng_in,az_in,nadd,n_max,pi,c,pxl_unit,
     +  ers,jers,rsat_s12,rsat_s37,rsat_ws,rsat_fr,rsat_eh,rsat_el,
     +  buff_in,array,buff_in_rd,
