c SccsId = @(#)spat_avg.f	2.41 3/24/98



	subroutine spat_avg(ia_loc_d2,na_smp,scale,
	...
	integer ierror
        ...
        character*128 SccsId_spat_avg
        data SccsId_spat_avg
     +  /'@(#)PPspat_avg.f:2.41'/
	...
	if(na_smp .gt. 8192) then
	   print *,'spat_avg: na_smp > 8192, increase imag_line size'
