c SccsId = @(#)mulply_phase1_air.f	2.41 3/24/98
	
	
	subroutine mulply_phase1_air(
     ...
     +  raw_file,image_file)
        ...
        character*128 SccsId_mulply_phase1_air
        data SccsId_mulply_phase1_air
     +  /'@(#)PPmulply_phase1_air.f:2.41'/
	...
	integer i,j
	real*8 f,a,k1,t_ref,r,dt,phase
