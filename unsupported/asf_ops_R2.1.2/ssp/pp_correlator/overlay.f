c SccsId = @(#)overlay.f	2.41 3/24/98

	subroutine overlay(ir_loc,ia_loc_d2,na_smp,ireset,image_buffer,
	...
	if(na_smp .gt. 8192) then
	   print *,'overlay: na_smp > 8192, increase imag_line size'
