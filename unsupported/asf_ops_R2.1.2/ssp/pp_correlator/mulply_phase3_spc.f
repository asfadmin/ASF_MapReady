c SccsId = @(#)mulply_phase3_spc.f	2.41 3/24/98


	subroutine mulply_phase3_spc(
     ...
     +  raw_file,image_file)
        ...
        character*128 SccsId_mulply_phase3_spc
        data SccsId_mulply_phase3_spc
     +  /'@(#)PPmulply_phase3_spc.f:2.41'/
	...
	real*8 f,a,k1,k2,r,dt,phi1,phi2,phi3,phase
    	real*8 fr,fd_ref,fr_ref,scale_f,scale_fref
	real*8 fd_cnt
	...
	dt = 2 * (r - r_ref)/c 
	phi1 = -pi * k2 * a * dt**2
	phi2 = pi * (f - fd_ref)**2*(1/fr - 1/fr_ref)
	phase = phi1 + phi2
