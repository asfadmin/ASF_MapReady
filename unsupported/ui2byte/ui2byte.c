...
SYNOPSIS: ui2byte <infile> <outfile>
		infile         base name (.img,.meta or .ddr)
        	outfile        base name (.img,.meta or .ddr)
...
PROGRAM HISTORY:
    ...
    2.1    11/--/02  P. Denny     Update to use new meta structure
...
void usage (char *name)
{
 ...
 printf("\n"
	"REQUIRED ARGUMENTS:\n"
	"   infile    base name (.img and .meta)\n"
	"   outfile   base name (.img and .meta)\n");
 printf("\n"
	"DESCRIPTION:\n"
	"   %s reads a INT*2 (short int) product, and scales\n"
	"   by histogram to byte version.");
 printf("\n"
