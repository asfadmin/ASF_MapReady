# makro paths
ROOT	= /sonja/calval/cal/src/andi
DRD	= $(ROOT)/lib/srcDrdlib
ANDI	= $(ROOT)/src/andi
TOOLS	= $(ROOT)/src/tools
TEST	= $(ROOT)/src/test
EXE	= /sonja/calval/cal/bin
OBJ	= $(ROOT)/obj 
LIB	= $(ROOT)/lib
...
ANDISRC	= $(ANDI)/fra.c $(ANDI)/foa.c $(ANDI)/al.c $(ANDI)/andi.c
ANDIOBJ	= $(OBJ)/fra.o $(OBJ)/foa.o $(OBJ)/al.o $(OBJ)/andi.o
FFTLIB  = /sonja/calval/cal/lib/rcal.a

PROF		= -p
DEBUG		= -g $(PROF)
CFLAGS		= -misalign -target sun4
LDLIBS  	= $(LIB)/drdlib.a $(LIB)/hjwlib.a
DEBUGLIBS	= /usr/lib/debug/malloc.o /usr/lib/debug/mallocmap.o
XLIBS		= -lxview -lolgx -lX11
MATH_LINK	= -lm
LINK		= cc $(DEBUG) -misalign -target sun4 -o $@ 
CC		= cc -c -O4 -I$(INC) -o $@ 
...
#######################################################
# test - test programs
$(EXE)/t: $(OBJ)/test.o $(LDLIBS)
	$(LINK) $(OBJ)/test.o $(LDLIBS) $(MATH_LINK)

$(OBJ)/test.o: $(TOOLS)/test.c
	$(CC) $(TOOLS)/test.c $(LDLIBS)
...
#######################################################
# andi program
$(EXE)/andi: $(ANDIOBJ) $(LDLIBS)
	$(LINK) $(ANDIOBJ) $(LDLIBS) $(DEBUGLIBS)

$(OBJ)/andi.o: $(ANDI)/andi.c $(ANDI)/andi.h $(INC)/drdapi.h
	$(CC) $(ANDI)/andi.c

$(OBJ)/fra.o: $(ANDI)/fra.c $(ANDI)/andi.h $(INC)/drdapi.h
	$(CC) $(ANDI)/fra.c

$(OBJ)/foa.o: $(ANDI)/foa.c $(ANDI)/andi.h $(INC)/drdapi.h
	$(CC) $(ANDI)/foa.c

$(OBJ)/al.o: $(ANDI)/al.c $(ANDI)/andi.h $(INC)/drdapi.h
	$(CC) $(ANDI)/al.c
