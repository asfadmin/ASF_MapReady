/***************************************************************************
        NAME:  parse_vdf -- extracts file names, record sizes, &
 	       volume info from a Volume Description File (VDF)   
      SYNTAX:  parse_vdf vdfname
  PARAMETERS:  vdfname -- name of VDF file to extract names from.	 
 DESCRIPTION:  This program prints an ASCII representation of
               the contents of a VDF file to stdout.  This is
               useful for checking the contents of a VDF.
