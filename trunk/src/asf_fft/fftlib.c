...
*************************************************/
#define inline
inline void bitrevR2(float *ioptr, int M, short *BRLow);
inline void bitrevR2(float *ioptr, int M, short *BRLow){
...
inline void bfR2(float *ioptr, int M, int NDiffU);
inline void bfR2(float *ioptr, int M, int NDiffU){
/*** 2nd radix 2 stage ***/
unsigned int	pos;
unsigned int	posi;
...
inline void bfR4(float *ioptr, int M, int NDiffU);
inline void bfR4(float *ioptr, int M, int NDiffU){
/*** 1 radix 4 stage ***/
unsigned int	pos;
unsigned int	posi;
...
inline void bfstages(float *ioptr, int M, float *Utbl, int Ustride, int NDiffU, int StageCnt);
inline void bfstages(float *ioptr, int M, float *Utbl, int Ustride, int NDiffU, int StageCnt){
/***   RADIX 8 Stages	***/
unsigned int	pos;
unsigned int	posi;
...
void ffts1(float *ioptr, int M, int Rows, float *Utbl, short *BRLow){
...
inline void scbitrevR2(float *ioptr, int M, short *BRLow, float scale);
inline void scbitrevR2(float *ioptr, int M, short *BRLow, float scale){
...
inline void ibfR2(float *ioptr, int M, int NDiffU);
inline void ibfR2(float *ioptr, int M, int NDiffU){
/*** 2nd radix 2 stage ***/
unsigned int	pos;
unsigned int	posi;
...
inline void ibfR4(float *ioptr, int M, int NDiffU);
inline void ibfR4(float *ioptr, int M, int NDiffU){
/*** 1 radix 4 stage ***/
unsigned int	pos;
unsigned int	posi;
...
inline void ibfstages(float *ioptr, int M, float *Utbl, int Ustride, int NDiffU, int StageCnt);
inline void ibfstages(float *ioptr, int M, float *Utbl, int Ustride, int NDiffU, int StageCnt){
/***   RADIX 8 Stages	***/
unsigned int	pos;
unsigned int	posi;
...
void ifftrecurs(float *ioptr, int M, float *Utbl, int Ustride, int NDiffU, int StageCnt);
void ifftrecurs(float *ioptr, int M, float *Utbl, int Ustride, int NDiffU, int StageCnt){
/* recursive bfstages calls to maximize on chip cache efficiency */
int i1;
if (M <= MCACHE)
...
void iffts1(float *ioptr, int M, int Rows, float *Utbl, short *BRLow){
...
inline void frstage(float *ioptr, int M, float *Utbl);
inline void frstage(float *ioptr, int M, float *Utbl){
/*	Finish RFFT		*/
...
void rffts1(float *ioptr, int M, int Rows, float *Utbl, short *BRLow){
...
inline void ifrstage(float *ioptr, int M, float *Utbl);
inline void ifrstage(float *ioptr, int M, float *Utbl){
/*	Start RIFFT		*/
...
void riffts1(float *ioptr, int M, int Rows, float *Utbl, short *BRLow){
