#ifndef _SR2GR_HELP_H_
#define _SR2GR_HELP_H_
...
#endif
#define TOOL_USAGE \
        TOOL_NAME" <infile> <outfile> <pixel size> [-license] [-version] [-help]"
...
#define TOOL_DESCRIPTION \
    "   Converts an image from slant range to ground range."
...
#define TOOL_OPTIONS \
    "   <pixel size>\n" \
    "        Specifies the desired ground range pixel size.\n"\
    "   -license\n" \
