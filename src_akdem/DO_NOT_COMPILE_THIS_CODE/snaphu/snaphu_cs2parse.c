/*-----------------------------------------------------------
  ...
  Parser for cs2 minimum cost flow solver.  Originally written
  by Andrew V. Goldberg and Boris Cherkassky to read DIMACS 
  format (text) input files.  Modified by Curtis W. Chen to 
  parse passed data from snaphu.  cs2 data structures also 
  modified by CWC to use less memory.

  This file is included with a #include from snaphu_cs2.c.
