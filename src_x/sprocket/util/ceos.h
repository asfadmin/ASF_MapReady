...
/*** RECORD TYPES ***/
#define IOFDR   3		/* Imagery Option File Descriptor 	*/
#define LFDR	4		/* Leader File Descriptor		*/
#define DSSR	5		/* Data Set Summary 			*/
#define MPDR	6		/* Map Projection Data			*/
#define PPDR    7		/* Platform Position Data		*/
#define ATDR    8		/* Attitude Data			*/
#define RADR	9		/* Radiometric Data 			*/
#define DQSR    10		/* Data Quality Summary 		*/
#define SDHR    11		/* Signal Data Histogram Record		*/
#define PDHR    12		/* Processed Data Histogram		*/
#define RNSR	13		/* Range Spectra Record			*/
#define DEMR	14		/* Digital Elevation Model	 	*/	
#define FACDR	15		/* Facility Data Record			*/
