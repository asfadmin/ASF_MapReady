...
public class Target {
	...
	public void injest_target ( StreamTokenizer st ) throws IOException
	  {
                ...
                //op_x = Double.parseDouble(read_element ( st, "OP_X"));
		op_x = extract_double ( "OP_X", read_element ( st, "OP_X"));
                //op_y = Double.parseDouble(read_element ( st, "OP_Y"));
		op_y = extract_double ( "OP_X", read_element ( st, "OP_Y"));
		//zone = double.parseDouble(read_element ( st, "ZONE"));
		zone = extract_double ( "ZONE", read_element ( st, "ZONE"));
        	//projected_image_x=Double.parseDouble(read_element ( 
		//		st, "PROJECTED_IMAGE_X"));
	...
	public void print ( )
          {
		System.err.println( "'" + cs_id+"' '"+cs_dev_id+"' '"+opr_name+"'" );
		System.err.println();
	  }
