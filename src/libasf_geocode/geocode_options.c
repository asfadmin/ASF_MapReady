...
"          --false-northing            : False Northing (optional)\n"
"\n"
"          You may omit the latitude-of-origin (the latitude at the image\n"\
"          center will be used), however the standard parallels and central\n"\
"          meridian are required.\n"
"\n"
...
"            HUGHES (Hughes Reference Spheroid 1980, by the Hughes\n"
"                    Aircraft Company)\n\n"
"          NOTE: The Hughes reference spheroid is only valid when used with a\n"
...
"          NOTE: When specifying a datum together with a non-UTM projection\n"
"          type, the following are the valid regions may be combined\n"
"          with each datum type:\n"
...
"          in these situations.\n"
"          \n"
"          NOTE: There are some circumstances that will result in\n"
"          insurmountable errors in spite of the -force flag being\n"
