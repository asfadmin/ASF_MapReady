/****************************************************************
FUNCTION NAME: gvnspkeyset

SYNTAX:  gvnspkeyset (ddr, gtif); 
...
DESCRIPTION:
    Set the geoTIFF keys for General Vertical Near-Side Perspective
          projection.
...

{
  ...
  /* General Vertical Near-Side Perspective is not a known projection
     in the current version of geoTIFF.  The height parameter is not
     carried over from LAS.  Plans to add PerspectiveHeightGeoKey
     for Revision 2.0 of geoTIFF are under consideration.
     ---------------------------------------------------------------- */

  GTIFKeySet(gtif, ProjectedCSTypeGeoKey, TYPE_SHORT, 1, 32767);
  GTIFKeySet(gtif, PCSCitationGeoKey, TYPE_ASCII, 0,
    "General Vertical Near-Side Perspective--incomplete implementation in geoTIFF");
