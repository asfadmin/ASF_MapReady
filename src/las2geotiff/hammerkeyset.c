...
PURPOSE:  Set the geoTIFF keys for Hammer projection.
...

{
  ...
  /* Hammer is not a known projection in the current version of geoTIFF.
     ------------------------------------------------------------------- */
  GTIFKeySet(gtif, ProjectedCSTypeGeoKey, TYPE_SHORT, 1, 32767);
  GTIFKeySet(gtif, PCSCitationGeoKey, TYPE_ASCII, 0,
           "Hammer--incomplete implementation in geoTIFF");
