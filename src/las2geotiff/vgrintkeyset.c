...
PURPOSE:  Set the geoTIFF keys for Van der Grinten projection.
...

{
  ...
  GTIFKeySet(gtif, ProjCoordTransGeoKey, TYPE_SHORT, 1, CT_VanDerGrinten);
  GTIFKeySet(gtif, PCSCitationGeoKey, TYPE_ASCII, 0,
                   "Van der Grinten converted from LAS");
