...
PURPOSE:  Set the geoTIFF keys for Mollweide projection.
...

{
  ...
  /* Mollweide is not a known projection in the current version of geoTIFF.
     ---------------------------------------------------------------------- */

  GTIFKeySet(gtif, ProjectedCSTypeGeoKey, TYPE_SHORT, 1, 32767);
  GTIFKeySet(gtif, PCSCitationGeoKey, TYPE_ASCII, 0,
                   "Mollweide--incomplete implementation in geoTIFF");
