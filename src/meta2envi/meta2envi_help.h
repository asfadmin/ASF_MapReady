#ifndef _META2ENVI_HELP_H_
#define _META2ENVI_HELP_H_
...
#endif
#define TOOL_USAGE \
        TOOL_NAME" [-log <logfile>] <meta_name> <envi_name>\n" \
...
#define TOOL_DESCRIPTION \
    "   The meta2envi tool creates an ENVI style header file (.hdr) from an ASF\n" \
    "   Internal format metadata file (.meta) so that ENVI software is able to\n" \
    "   read an ASF Internal format data file (.img)"
