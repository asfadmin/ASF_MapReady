...
typedef struct {
  ...
  double x[45];           // Transform coeffs for x (ls to lon)
  double y[45];           // Transform coeffs for y (ls to lat)
  double origin_pixel;    // Origin pixel (P0)
  double origin_line;     // Origin line (L0)
  double l[45];           // Transform coeffs for lines (lat/lon to l)
  double s[45];           // Transform coeffs for samples (lat/lon to s)
