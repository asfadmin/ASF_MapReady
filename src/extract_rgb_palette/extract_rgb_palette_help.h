#ifndef _EXTRACT_RGB_PALETTE_HELP_H_
#define _EXTRACT_RGB_PALETTE_HELP_H_
...
#define TOOL_DESCRIPTION \
    "   The extract_rgb_palette tool scans a graphics file image for a palette associated\n" \
    "   with indexed RGB color mapping and dumps this palette to stdout."
...
#endif
#define TOOL_OUTPUT \
    "   Output is to stdout (screen) only.  Format:\n\n" \
    "   <pixelvalue> <red component> <green component> <blue component>\n" \
    "     ...etc\n\n" \
    "   Pixel value range varies by data type contained in the file.  RGB components\n" \
    "   range from 0 to 255."
...
#define TOOL_LIMITATIONS \
    "  Only TIFF and GeoTIFF files are currently supported."
...
#endif // _EXTRACT_RGB_PALETTE_HELP_H_
