...
#define D2R (PI/180.0)
#define R2D (180.0/PI)
#define DEGREES2ARCMINUTES 60
#define ARCMINUTES2DEGREES (1/DEGREES2ARCMINUTES)
#define DEGREES2ARCSECONDS 3600
#define ARCSECONDS2DEGREES (1/DEGREES2ARCSECONDS)
