/*****************************************************************************
NAME: fftMatchOptical

SYNOPSIS: fftMatchOptical [-log <file>] [-quiet] <img1.ext> <img2.ext>
...
int main(int argc,char **argv)
{
  ...
  handle_common_asf_args(&argc, &argv, "fftMatchOptical");
  ...
  if (argc != nArg) {
    ...
    fftMatch_opt(inFile1, inFile2, &bestLocX, &bestLocY);
