...
void overlay_img(hostin,nmrimg,wind,bands,nbands,sl,ss,mask,hostout,
		     dtype,totbnd,nl,ns,replace,leave,aver,update,laver)

char    *hostin;		 /* pointer to input host file descriptor     */
