...
void usage(char *mess1,char *mess2)
{
	printf("\n"
		...
		"   data (without any extension) into the given output\n"
		"   image (with extension). Quicklook is much faster\n"
		"   than a regular SAR processor (e.g. ardop), but the\n"
		"   images are low-resolution and grainy.\n"
		"\n"
