...
{
	complexFloat *out,*rng_out,*az_out;
	int patchlet,y,x;
	...
	out=(complexFloat *)malloc(sizeof(complexFloat)*rngO*azFFT);
	rng_out=(complexFloat *)malloc(sizeof(complexFloat)*s->rng.fftLen);
	az_out=(complexFloat *)malloc(sizeof(complexFloat)*s->az.fftLen);
