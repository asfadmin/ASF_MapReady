...
#include "geolocate.h"
#include "asf_meta.h"
#include "ardop_defs.h" // Requires asf_complex.h, read_signal.h, geolocate.h, asf_meta.h. For for complexFloat, cfft1d
#include "specan.h"
...
void specan_process(specan_struct *s,complexFloat *input,complexFloat *output)
{
    register int i,len=s->fftLen,oNum=s->oNum-1;
    register complexFloat *deramp=s->deramp;
    complexFloat xform[SPECAN_MAXFFT];/*Transform array*/
