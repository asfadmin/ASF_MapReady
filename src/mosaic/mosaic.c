...
"     command line.  Where the input images overlap, the pixel in the image listed\n"
"     first on the command-line will be utilized for determining the output pixel\n"
...
"     blank areas in the output image.  If the geographical location in the various\n"
"     data files are too far apart or the projection type and parameters don't make\n"
"     sense for all the files in the input file list, errors may occur.\n\n"
"Output:\n"
