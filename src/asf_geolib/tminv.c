...
static int ind;		/* sphere flag value			*/


/* Initialize the Universal Transverse Mercator (UTM) projection
  -------------------------------------------------------------*/
int utminvint(r_maj,r_min,scale_fact,zone)
...
/* Initialize the Transverse Mercator (TM) projection
  -------------------------------------------------------------*/
int tminvint(r_maj,r_min,scale_fact,center_lon,center_lat,false_east,false_north)
